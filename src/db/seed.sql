...
-- tien_te_th must be set explicitly (do not rely on column position after ALTER/rebuild)
INSERT OR IGNORE INTO lo_hang (id, chuyen_xe_id, khach_hang_id, hang_id, so_kien, da_tra_hang, don_gia, tien_te, thanh_tien, so_tien_hang, giam_gia, nguoi_tao, nguoi_thu, tien_te_th) VALUES
  ('F260526-50-001', 'F260526-50', 'KH-001', 'H-003', 240, 240, 100, 'PLN', 24000, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('F260526-50-002', 'F260526-50', 'KH-002', 'H-003', 128, 128, 85, 'EUR', 10880, 5000, 0, 'NV-005', 'NV-005', 'EUR'),
  ('W260526-47-001', 'W260526-47', 'KH-001', 'H-001', 182, 182, 100, 'PLN', 18200, 0, 200, 'NV-005', 'NV-005', 'PLN'),
  ('W260526-47-002', 'W260526-47', 'KH-002', 'H-002', 76, 72, 80, 'PLN', 6080, 0, 0, 'NV-009', 'NV-005', 'PLN'),
  ('F260525-50-001', 'F260525-50', 'KH-004', 'H-004', 95, 93, 80, 'PLN', 7600, 12000, 0, 'NV-009', 'NV-005', 'PLN'),
  ('F260524-50-001', 'F260524-50', 'KH-001', 'H-001', 149, 149, 100, 'PLN', 14900, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('W260524-47-001', 'W260524-47', 'KH-002', 'H-002', 320, 200, 40, 'PLN', 12800, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('W260523-46-001', 'W260523-46', 'KH-001', 'H-001', 204, 204, 100, 'PLN', 20400, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('W260523-46-002', 'W260523-46', 'KH-005', 'H-003', 110, 110, 100, 'PLN', 11000, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('W260522-46-001', 'W260522-46', 'KH-003', 'H-001', 111, 111, 100, 'PLN', 11100, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('F260522-48-001', 'F260522-48', 'KH-001', 'H-001', 175, 175, 100, 'PLN', 17500, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('C260520-48-001', 'C260520-48', 'KH-004', 'H-005', 220, 100, 80, 'PLN', 17600, 8000, 0, 'NV-005', 'NV-005', 'PLN'),
  ('P260519-46-001', 'P260519-46', 'KH-005', 'H-001', 50, 50, 0, 'PLN', 1800, 0, 0, 'NV-009', 'NV-005', 'PLN'),
  ('F260526-50-003', 'F260526-50', 'KH-005', 'H-001', 65, 60, 85, 'PLN', 5525, 0, 25, 'NV-005', 'NV-005', 'PLN'),
  ('F260526-49-001', 'F260526-49', 'KH-006', 'H-007', 150, 150, 90, 'PLN', 13500, 8000, 0, 'NV-005', 'NV-005', 'PLN'),
  ('F260526-47-001', 'F260526-47', 'KH-003', 'H-001', 120, 120, 90, 'PLN', 10800, 5500, 0, 'NV-005', 'NV-005', 'PLN'),
  ('F260523-53-001', 'F260523-53', 'KH-007', 'H-008', 200, 200, 95, 'PLN', 19000, 0, 200, 'NV-005', 'NV-005', 'PLN'),
  ('F260526-49-002', 'F260526-49', 'KH-008', 'H-003', 120, 120, 85, 'PLN', 10200, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('F260526-49-003', 'F260526-49', 'KH-011', 'H-003', 140, 140, 90, 'PLN', 12600, 7000, 0, 'NV-005', 'NV-005', 'PLN'),
  ('F260526-49-004', 'F260526-49', 'KH-014', 'H-007', 130, 120, 100, 'PLN', 13000, 6500, 0, 'NV-005', 'NV-005', 'PLN'),
  ('F260523-53-002', 'F260523-53', 'KH-009', 'H-007', 75, 75, 100, 'PLN', 7500, 4000, 0, 'NV-009', 'NV-005', 'PLN'),
  ('F260523-53-003', 'F260523-53', 'KH-013', 'H-008', 160, 160, 95, 'PLN', 15200, 9000, 0, 'NV-005', 'NV-005', 'PLN'),
  ('W260525-51-001', 'W260525-51', 'KH-006', 'H-006', 80, 80, 90, 'PLN', 7200, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('W260525-51-002', 'W260525-51', 'KH-007', 'H-001', 110, 110, 95, 'PLN', 10450, 5000, 0, 'NV-005', 'NV-005', 'PLN'),
  ('W260525-51-003', 'W260525-51', 'KH-009', 'H-002', 95, 95, 100, 'PLN', 9500, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('W260525-51-004', 'W260525-51', 'KH-011', 'H-001', 70, 70, 90, 'PLN', 6300, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('W260525-51-005', 'W260525-51', 'KH-012', 'H-006', 85, 85, 85, 'PLN', 7225, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('W260525-51-006', 'W260525-51', 'KH-013', 'H-010', 55, 55, 95, 'PLN', 5225, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('W260525-51-007', 'W260525-51', 'KH-015', 'H-002', 65, 65, 90, 'PLN', 5850, 0, 0, 'NV-005', 'NV-005', 'PLN'),
  ('C260524-52-001', 'C260524-52', 'KH-001', 'H-005', 80, 80, 120, 'PLN', 9600, 15000, 0, 'NV-005', 'NV-005', 'PLN'),
  ('C260524-52-002', 'C260524-52', 'KH-008', 'H-005', 60, 60, 85, 'PLN', 5100, 3500, 0, 'NV-005', 'NV-005', 'PLN'),
  ('C260524-52-003', 'C260524-52', 'KH-011', 'H-005', 50, 50, 90, 'PLN', 4500, 2500, 0, 'NV-005', 'NV-005', 'PLN'),
  ('C260524-52-004', 'C260524-52', 'KH-013', 'H-009', 75, 75, 95, 'PLN', 7125, 4500, 0, 'NV-005', 'NV-005', 'PLN'),
  ('C260524-52-005', 'C260524-52', 'KH-015', 'H-005', 90, 90, 90, 'PLN', 8100, 5000, 0, 'NV-005', 'NV-005', 'PLN'),
  ('K260521-49-001', 'K260521-49', 'KH-010', 'H-007', 180, 180, 80, 'EUR', 14400, 0, 0, 'NV-005', 'NV-005', 'EUR'),
  ('K260520-52-001', 'K260520-52', 'KH-010', 'H-008', 90, 90, 80, 'EUR', 7200, 5000, 0, 'NV-005', 'NV-005', 'EUR');
